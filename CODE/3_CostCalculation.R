...
percAA <-
  read.csv("4_alldataclean/percAADataColCheck00_GBIF_checked.csv") # Amphibians
percBB <-
  read.csv("4_alldataclean/percBBDataColCheck00_GBIF_checked.csv") # Birds
percMM <-
  read.csv("4_alldataclean/percMMDataColCheck00_GBIF_checked.csv") # Mammals
percRR <-
  read.csv("4_alldataclean/percRRDataColCheck00_GBIF_checked.csv") # Reptiles
...
# For subspecies, sum overlaps on species level
overlap.sum <- aggregate(overlap.sum ~ gbif.species,
                         data = overlap.sum, FUN = sum)
